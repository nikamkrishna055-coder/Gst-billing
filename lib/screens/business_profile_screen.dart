...
class _BusinessProfileScreenState extends State<BusinessProfileScreen> {
  ...
  final List<String> _indianStates = <String>[
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          // ✅ State with Indian states autocomplete
                          Autocomplete<String>(
                            ...
                            optionsBuilder: (TextEditingValue textEditingValue) {
                              ...
                              return _indianStates.where(
                                (String state) => state.toLowerCase().startsWith(
                            ...
                            fieldViewBuilder: (
                              ...
                              if (fieldController.text.isEmpty &&
                                ...
                                fieldController.text = _stateController.text;
                              }
