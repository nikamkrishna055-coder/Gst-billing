...
class FirestoreService {
  ...
  Future<void> uploadUserProfilePhoto(XFile photoFile) async {
    final String uid = _requireUid();
    final FirebaseStorage storage = FirebaseStorage.instance;

    try {
      // Create a reference to the file location
      final Reference ref = storage.ref('profile_photos/$uid/profile.jpg');

      // Read file as bytes (works on web and mobile)
      final List<int> fileBytes = await photoFile.readAsBytes();
